...
@section('content')
    <div class="fixed top-0 left-1/2 -translate-x-1/2 w-full max-w-[430px] z-50">
        <div class="bg-figmaRed h-32 flex items-center px-8 rounded-b-[40px] shadow-lg">
            ...
            <h1 class="text-white text-xl font-bold tracking-tight">Edit Akun Satpam</h1>
        </div>
    </div>
    ...
    <div class="px-6 pb-20">
        <div class="bg-white rounded-[32px] shadow-xl shadow-gray-100 border border-gray-50 flex overflow-hidden">
            ...
            <div class="flex-grow p-8">
                <h2 class="text-xl font-black text-gray-950 mb-2">Edit Akun</h2>
                <p class="text-[11px] text-gray-400 font-medium mb-8">
                    Perbarui informasi akun petugas satpam di bawah ini
                </p>

                <form action="{{ route('satpam.update', $satpam->id_user) }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nama_user" value="{{ old('nama_user', $satpam->nama_user) }}"
                                class="w-full pl-12 pr-4 py-4 bg-gray-50 border border-gray-100 rounded-2xl text-sm font-bold focus:ring-2 focus:ring-figmaRed/20 focus:bg-white outline-none transition-all"
                    ...
                    <div class="mb-8">
                        <label class="block text-xs font-bold text-gray-950 mb-2 ml-1">Password Baru (Opsional)</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400">
                                <i class="fas fa-lock"></i>
                            </div>
                            <input type="password" name="password" id="pass"
                                class="w-full pl-12 pr-12 py-4 bg-gray-50 border border-gray-100 rounded-2xl text-sm font-bold focus:ring-2 focus:ring-figmaRed/20 focus:bg-white outline-none transition-all placeholder:text-gray-300 placeholder:font-normal placeholder:italic"
                    ...
                    @if ($errors->any())
                        <div class="flex items-center gap-2 mb-8 ml-1">
                            ...
                            <p class="text-[10px] text-figmaRed font-bold">Terjadi kesalahan. Silahkan periksa kembali form.
                            </p>
                        </div>
                    @endif
    ...
    @if (session('success'))
        <div id="successModal"
            ...
            <div class="bg-white w-full max-w-[320px] rounded-[40px] p-10 text-center shadow-2xl">
                ...
                <p class="text-[11px] text-gray-400 font-medium mb-10">Perubahan akun berhasil disimpan</p>
